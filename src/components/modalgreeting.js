  ...
  render() {
    return (
      <div className='Modal' class="container">
        <h1 class="display-4">Welcome to Marvify!</h1>
        <p class="lead">Hello, {this.props.username}! Thank you for taking the time to play my game. This is a 10 question quiz to see how well you know your favorite artist's top songs!</p>
        <p class="lead">As soon as you click 'play', your spotify account will immediately create a playlist of your top artist's favorite songs. You will be prompted 10 questions, one by one, 
